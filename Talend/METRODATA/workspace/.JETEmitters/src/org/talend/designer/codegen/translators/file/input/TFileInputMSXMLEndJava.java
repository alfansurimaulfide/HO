...
public class TFileInputMSXMLEndJava
{
  ...
  protected final String TEXT_23 = NL + "\ttry {" + NL + "\t\tlooper_";
  protected final String TEXT_24 = ".handleTaskResponse();" + NL + "\t} catch(java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_25 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "\t";
  protected final String TEXT_26 = NL + "\t\tthrow e;" + NL + "\t";
  protected final String TEXT_27 = NL + "\t\tlog.error(\"";
  protected final String TEXT_28 = " - \" + e.getMessage());" + NL + "\t";
  protected final String TEXT_29 = NL + "\t\tSystem.err.println(e.getMessage());\t" + NL + "\t";
