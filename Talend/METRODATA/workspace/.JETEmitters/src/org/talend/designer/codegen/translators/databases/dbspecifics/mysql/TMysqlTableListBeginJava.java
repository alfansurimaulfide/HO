...
public class TMysqlTableListBeginJava
{
  ...
  protected final String TEXT_62 = NL + "String db_";
  ...
  protected final String TEXT_67 = " = \"\";" + NL + "" + NL + "if(whereClause_";
  protected final String TEXT_68 = " != null && whereClause_";
  protected final String TEXT_69 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_70 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type<>'VIEW' AND table_schema='\" + db_";
  protected final String TEXT_71 = " + \"' AND (\" + whereClause_";
  protected final String TEXT_72 = " + \") ORDER BY table_name ASC\";" + NL + "" + NL + "}else{" + NL + "" + NL + "\tquery_";
  protected final String TEXT_73 = " + \"' ORDER BY table_name ASC\";" + NL + "" + NL + "}";
  protected final String TEXT_74 = NL + "    log.info(\"";
  protected final String TEXT_75 = " - Query:'\"+query_";
  protected final String TEXT_76 = "+\"'.\");";
  protected final String TEXT_77 = NL + NL + "int nb_table_";
  protected final String TEXT_78 = " = 0;" + NL + "" + NL + "java.sql.Statement stmt2_";
  protected final String TEXT_79 = " = conn_";
  protected final String TEXT_80 = ".createStatement();" + NL + "" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_81 = " = stmt2_";
  protected final String TEXT_82 = ".executeQuery(query_";
  protected final String TEXT_83 = ");" + NL + "" + NL + "while (rs_";
  protected final String TEXT_84 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_85 = " = rs_";
  protected final String TEXT_86 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_87 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_88 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_89 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_90 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_91 = " - Name of table \"+nb_table_";
  protected final String TEXT_92 = "+\":\"+currentTableName_";
  protected final String TEXT_93 = "+\".\");" + NL + "\t";
  protected final String TEXT_94 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_95 = "_CURRENT_TABLE\", currentTableName_";
