...
public class TFileInputRegexEndJava
{
  ...
  protected final String TEXT_23 = NL + "\t\t\tif(!(source_";
  protected final String TEXT_24 = " instanceof java.io.InputStream)){" + NL + "            \tin";
  protected final String TEXT_25 = ".close();" + NL + "            }" + NL + "            in";
  protected final String TEXT_26 = " = null;" + NL + "            globalMap.put(\"";
