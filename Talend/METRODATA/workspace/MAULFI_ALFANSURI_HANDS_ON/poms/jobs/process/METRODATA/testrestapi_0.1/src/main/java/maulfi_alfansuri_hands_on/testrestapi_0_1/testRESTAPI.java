...
package maulfi_alfansuri_hands_on.testrestapi_0_1;
 ...
 * @status
 */
public class testRESTAPI implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (webHook_url != null) {
				...
				this.setProperty("webHook_url", webHook_url.toString());
	...
	private final String jobName = "testRESTAPI";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(testRESTAPI.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI = new byte[0];
		static byte[] commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI.length) {
					if (length < 1024 && commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI.length == 0) {
						commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI = new byte[1024];
					} else {
						commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI, 0, length);
				strReturn = new String(commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI, 0, length);
				strReturn = new String(commonByteArray_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MAULFI_ALFANSURI_HANDS_ON_testRESTAPI) {
...
globalMap.put("tFileInputJSON_1_ERROR_MESSAGE",e.getMessage());
          ...
          return recordMaxSize;
	                   ...
	                   void setRowValue_0(row1Struct row1, java.util.List<org.json.simple.JSONArray> JSONResultList_tFileInputJSON_1, int nbResultArray_tFileInputJSON_1) throws java.io.UnsupportedEncodingException{
							        if(JSONResultList_tFileInputJSON_1.get(0) != null && nbResultArray_tFileInputJSON_1<JSONResultList_tFileInputJSON_1.get(0).size() && JSONResultList_tFileInputJSON_1.get(0).get(nbResultArray_tFileInputJSON_1)!=null){		
			                                row1.content = JSONResultList_tFileInputJSON_1.get(0).get(nbResultArray_tFileInputJSON_1).toString();
							        }else{
...
javax.script.ScriptEngine jsEngine_tFileInputJSON_1 = scriptEngineMgr_tFileInputJSON_1.getEngineByName("JavaScript");
if (jsEngine_tFileInputJSON_1 == null) {
	
    System.err.println("No script engine found for JavaScript");
} else {
    java.net.URL jsonjsUrl_tFileInputJSON_1 = com.jsonpath.test.ReadJar.class.getResource("json.js");
    if(jsonjsUrl_tFileInputJSON_1!=null) {
    	jsEngine_tFileInputJSON_1.eval(new java.io.BufferedReader(new java.io.InputStreamReader(jsonjsUrl_tFileInputJSON_1.openStream())));
    }
    
    java.net.URL jsonpathjsUrl_tFileInputJSON_1 = com.jsonpath.test.ReadJar.class.getResource("jsonpath.js");
    if(jsonpathjsUrl_tFileInputJSON_1!=null) {
		jsEngine_tFileInputJSON_1.eval(new java.io.BufferedReader(new java.io.InputStreamReader(jsonpathjsUrl_tFileInputJSON_1.openStream())));
	}
	    Object filenameOrStream_tFileInputJSON_1 = null;
        try {
            filenameOrStream_tFileInputJSON_1 = "D:/HO/HO/Talend/METRODATA/workspace/success_discord.json";
	...
	java.io.BufferedReader fr_tFileInputJSON_1 = null;
		try{
	        if(filenameOrStream_tFileInputJSON_1 instanceof java.io.InputStream){
	            fr_tFileInputJSON_1 = new java.io.BufferedReader(new java.io.InputStreamReader((java.io.InputStream)filenameOrStream_tFileInputJSON_1,"UTF-8"));
	        }else{
	            fr_tFileInputJSON_1 = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream((String)filenameOrStream_tFileInputJSON_1),"UTF-8"));
	        }
	       
		jsonText_tFileInputJSON_1 = org.json.simple.JSONValue.parse(fr_tFileInputJSON_1);
		if(jsonText_tFileInputJSON_1 == null) {
			throw new RuntimeException("fail to parse the json file : " +  "D:/HO/HO/Talend/METRODATA/workspace/success_discord.json" );
		}
	} catch(java.lang.Exception e_tFileInputJSON_1) {
globalMap.put("tFileInputJSON_1_ERROR_MESSAGE",e_tFileInputJSON_1.getMessage());
...
recordMaxSize_tFileInputJSON_1=jsonUtil_tFileInputJSON_1.getData(,invocableEngine_tFileInputJSON_1,JSONResultList_tFileInputJSON_1,recordMaxSize_tFileInputJSON_1);
	...
	for(int nbResultArray_tFileInputJSON_1 = 0; nbResultArray_tFileInputJSON_1 < recordMaxSize_tFileInputJSON_1; nbResultArray_tFileInputJSON_1++){
		...
		nb_line_tFileInputJSON_1++;
                	...
                	row1 = new row1Struct();
                	try{
                            jsonUtil_tFileInputJSON_1.setRowValue_0(row1,JSONResultList_tFileInputJSON_1,nbResultArray_tFileInputJSON_1);
                    } catch (java.lang.Exception e) {
globalMap.put("tFileInputJSON_1_ERROR_MESSAGE",e.getMessage());
 ...
 */
	...
	public static void main(String[] args) {
		final testRESTAPI testRESTAPIClass = new testRESTAPI();

		int exitCode = testRESTAPIClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = testRESTAPI.class.getClassLoader().getResourceAsStream(
					"maulfi_alfansuri_hands_on/testrestapi_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = testRESTAPI.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("webHook_url", "id_String");
					if (context.getStringValue("webHook_url") == null) {
						context.webHook_url = null;
					} else {
						context.webHook_url = (String) context.getProperty("webHook_url");
					}
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("webHook_url")) {
				context.webHook_url = (String) parentContextMap.get("webHook_url");
			}
		}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : testRESTAPI");
		}
...
/************************************************************************************************
 * 40779 characters generated by Talend Open Studio for Big Data on the 25
 * September 2023 at 21:13:32 ICT
 ************************************************************************************************/